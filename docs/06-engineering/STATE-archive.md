# STATE archive (pre-2026-07-10 compaction)

> Historical build log, preserved verbatim when STATE.md was compacted to a current-truth
> document on 2026-07-10. Newest entries first. For the live state, see [/STATE.md](../../STATE.md).
